...
int main(void)
{
  ...
  /* definition and creation of AppMainTask */
  osThreadDef(AppMainTask, AppMain, osPriorityLow, 0, 8048);
  AppMainTaskHandle = osThreadCreate(osThread(AppMainTask), NULL);
